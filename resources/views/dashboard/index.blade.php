...
<head>
    ...
    <title>Human Resource Handling</title>
...
<div class="page-content"> 
    ...
    <script src="{{ asset('mazer/dist/assets/static/js/initTheme.js') }}"></script>components/dark.js"></script>
    <script src="{{ asset('mazer/dist/assets/static/js/initTheme.js') }}"></script>extensions/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    
    
    <script src="{{ asset('mazer/dist/assets/static/js/initTheme.js') }}"></script>compiled/js/app.js"></script>
    

    
<!-- Need: Apexcharts -->
<script src="{{ asset('mazer/dist/assets/static/js/initTheme.js') }}"></script>extensions/apexcharts/apexcharts.min.js"></script>
<script src="{{ asset('mazer/dist/assets/static/js/initTheme.js') }}"></script>pages/dashboard.js"></script>
